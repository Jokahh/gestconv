 ...
 */
final class Version20230613091125 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tramo CHANGE orden orden INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tramo CHANGE orden orden VARCHAR(100) DEFAULT NULL');
    }
}
